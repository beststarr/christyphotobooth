...
>
  <div className="flex flex-col lg:flex-row items-start bg-white shadow-lg rounded-lg p-4 max-w-full w-full">
    <div className="flex flex-col items-center mr-6 w-full max-w-[320px] sm:max-w-[480px]">
...
>
      ...
      {photos.map((photo, index) => (
        <img
          ...
          src={photo}
          alt={`Foto ${index + 1}`}
          className="border mb-2 w-full h-auto max-w-[160px] sm:max-w-[180px] rounded-2xl shadow-md"
